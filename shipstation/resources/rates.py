...
class RatesResource:
    ...
    def calculate(self, *, body: CalculateRatesRequestBody) -> CalculateRatesResponseBody:
        ...
        response = self._api.request("POST", "/v2/rates", params=None, json_body=body.model_dump(exclude_none=True, by_alias=True) if hasattr(body, 'model_dump') else body)
    ...
    def estimate(self, *, body: EstimateRatesRequestBody) -> EstimateRatesResponseBody:
        """Get Rate Estimates"""
        response = self._api.request("POST", "/v2/rates/estimate", params=None, json_body=body.model_dump(exclude_none=True, by_alias=True) if hasattr(body, 'model_dump') else body)
